pipeline {
    ...
    // nom image DockerHub
        registry = "marjorie40/webspringboot2026"
    ...
    stages {
        ...
        stage('Git Checkout') {
            ...
            //recup du depot GitHub du projet
                git branch: 'main',
                    ...
                    url: 'https://github.com/marjorie40/web_app.git'
            }
        }
        ...
        stage('Build Docker Image') {
            steps {
                script {
                    docker.build('marjorie40/webspringboot2026:latest', '-f Dockerfile .')
                }
            }
        }
            ...
            steps {
                ...
                script {
                    docker.withRegistry('', registryCredential) {
                        docker.image('marjorie40/webspringboot2026:latest').push()
                    }
                }
            }
        }
